...
- **Zone level ranges on the world map.** On a continent map each zone shows its level range, such as 10-20 on Darkshore, coloured like quest levels: grey and green are below you, yellow is your level, orange and red are above. The colours follow you as you level. Pointing at a zone adds its range after the name as well. Forever's map data carries no ranges, so these are the original game's; cities, battlegrounds and Forever's new zones show none. Turn it off under Maps.
