...
- **Gear groups.** Ctrl+Right-click a bag item to put it in a named group such as Healing or DPS, and equip a whole group from the same menu. Grouped items and Equipment Manager sets get a badge in your bags and a tooltip line, and the weapons a fishing pole replaces are remembered so you can put them back on.
