...
- **One settings page in the game's own style**, under Options → AddOns, with `/tweaks` as a shortcut. Features another addon already handles are greyed out with that addon named, and this is rechecked each time the settings open.
