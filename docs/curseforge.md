...
- **Interface**: move and scale Blizzard windows from a Windows tab in Edit Mode, per layout. Quiet the errors a spammed macro repeats. Campsite features say what they give and whether you have it. The reagent bag joins the combined bag under its own name. `/rl` reloads.
