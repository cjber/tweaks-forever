...
- **Quests and camps**: the quest tracker sorts nearest first, with distances. A creature you need to kill for a quest shows your progress in its tooltip and a quest icon by its nameplate. With QuestieDB installed, pointing at a quest giver on the minimap lists their quests for you, and creatures that drop quest items get progress and icons too. Campsite features say what they give and whether you have it, and the Campfire Nearby buff lists your camp benefits and which way the fire is. Each benefit you gain is named at the top of the screen.
