...
- **Maps**: every dungeon and raid entrance gets retail's icon, named when you point at it. Zones show their level range after the name, coloured like quest levels. Unexplored areas are revealed, tinted so explored ground still stands out.
...
- **Quests and camps**: the quest tracker sorts nearest first, with distances. Campsite features say what they give and whether you have it, and the Campfire Nearby buff lists your camp benefits and which way the fire is.
